      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="mx-auto max-w-3xl text-center">
          <h2 className="font-heading text-3xl font-bold tracking-tight text-primary-foreground sm:text-5xl mb-6 text-balance">
            Sẵn sàng nâng cao năng suất đội ngũ?
          </h2>
          <p className="text-lg text-primary-foreground/90 leading-relaxed mb-10">
            Tham gia hàng trăm công ty đang sử dụng HUIT Task Manager để quản lý giao việc hiệu quả. Bắt đầu dùng thử
            miễn phí ngay hôm nay—không cần thẻ tín dụng.
          </p>
          ...
          <p className="mt-6 text-sm text-primary-foreground/80">
            Dùng thử 14 ngày • Không cần thẻ tín dụng • Hủy bất cứ lúc nào
          </p>
        </div>
      </div>
