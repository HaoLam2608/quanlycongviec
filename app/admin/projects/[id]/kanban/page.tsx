...
export default function KanbanPage() {
  ...
  // Mặc định luôn false trừ khi explicitly set true
  const actualSubtasksView = false;
  console.log('📋 Kanban Page Debug:');
  console.log('- projectId:', projectId);
  console.log('- subtasksView:', subtasksView);
  ...
  const handleTaskClick = (task: any) => {
    // Có thể mở modal hoặc chuyển sang trang chi tiết task
