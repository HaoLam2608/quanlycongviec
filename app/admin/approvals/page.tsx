                    ...
                    <div className="flex items-center justify-between mb-4">
                        <div>
                            <h1 className="text-3xl font-bold text-gray-900 mb-2">
                                Quản lý phê duyệt hoàn thành công việc
                            </h1>
                            <p className="text-gray-600">
                                Xem và phê duyệt các yêu cầu hoàn thành công việc từ toàn bộ nhân viên
                            </p>
                        </div>
                                        ...
                                        <div className="flex items-start justify-between">
                                            <div className="flex-1">
                                                ...
                                                <div className="flex items-center gap-6 text-sm text-gray-500">
                                                    ...
                                                    <div className="flex items-center gap-1">
                                                        <User className="w-4 h-4" />
                                                        <span>Người giao: {task.nguoiGiao.hoten}</span>
                                                    </div>
                                                    {task.ngayKetThuc && (
                                                        <div className="flex items-center gap-1">
                                                    ...
                                                    <div className="flex items-center gap-1">
                                                        ...
                                                        <span>Yêu cầu: {formatDate(task.updatedAt)}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="flex items-start justify-between">
                                            <div className="flex-1">
                                                ...
                                                <div className="flex items-center gap-6 text-sm text-gray-500">
                                                    ...
                                                    <div className="flex items-center gap-1">
                                                        <Clock className="w-4 h-4" />
                                                        <span>Yêu cầu: {formatDate(subtask.updatedAt)}</span>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div className="bg-white rounded-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-2xl border-2 border-gray-200">
                            ...
                            <div className="p-6 space-y-6">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        <label className="text-sm font-medium text-gray-700">Thời gian yêu cầu</label>
                                        <p className="mt-1 text-gray-900">{formatDate(selectedItem.updatedAt)}</p>
                                    </div>
                                </div>
