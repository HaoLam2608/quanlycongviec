...
export default function PMDashboard() {
    ...
    const loadStats = async () => {
        ...
        try {
            ...
            const activeTasksCount = data.activeTasksCount || 0
            const teamMembersCount = data.teamMembersCount || 0
            const progressAverage = data.progressAverage || 0
    ...
    return (
        <div className="space-y-8">
            {/* Header */}
            <div>
                <h1 className="text-4xl font-bold text-foreground mb-2 text-balance">Xin chào! 👋</h1>
                <p className="text-muted-foreground text-lg">Đây là tổng quan về các dự án của bạn</p>
            </div>
